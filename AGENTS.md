...
unconfirmed publication has no retry command: use its read-only reconciliation
commands before deciding what to do. From the space root, use
...
is unconfirmed, inspect the exact remote branch named in the error before
deciding whether to retry. Use
