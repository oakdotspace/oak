...
impl MountCore {
    ...
    pub fn new(
        ...
        for entry in &manifest.entries {
            ...
            // Apply the project-scope filter (if any) before inserting. We
            // test the post-rename display path so a rename out of scope hides
            // the file, and a rename into scope exposes it.
