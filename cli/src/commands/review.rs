...
pub async fn remote_branch_review_json(
    ...
    let merge_preview_data =
        merge_preview_for_remote_branch(repo, &preparation.source, &preparation.target)?;
...
fn merge_preview_from_evidence(
    ...
    let base_manifest = match crate::commands::merge::resolve_merge_base_from_heads(
        repo,
        branch,
        branch_head.as_ref(),
        parent.as_deref(),
