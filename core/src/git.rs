...
use crate::{
    Blob, Branch, BranchStatus, Capabilities, ChunkInfo, Commit, FileChange, FileMode, Hash,
    Manifest, ManifestEntry, MetadataKey, OakError, Result, Tag,
};
...
fn split_author(author: &str) -> (String, String) {
    ...
    (author.to_string(), "oak@oakvcs.com".to_string())
}
