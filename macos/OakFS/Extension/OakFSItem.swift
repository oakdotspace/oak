...
// -------------------------
// FSKit's Swift API changed across macOS 15.x betas and again for the
// macOS 26 synthetic-resource (FSPathURLResource) support. The exact
// signatures of FSVolume.Operations / FSUnaryFileSystemOperations should be
// reconciled against the SDK you build with (`xcrun --sdk macosx
// --show-sdk-path` → FSKit.framework headers / the Swift interface). The
// oak-specific logic — mapping each operation to a `DaemonClient` call and
